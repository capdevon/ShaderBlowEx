...
public class BetterGroundFogFilterTest extends SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        debugText.setText("Lvl:" + currentGroundLevel + " Dens:" + currentFogDensity + " Shin:" + currentSunShininess
                + " BndX:" + currentFogBoundaryX + " BndY:" + currentFogBoundaryY + " BndZ:" + currentFogBoundaryZ
                + " BndW:" + currentFogBoundaryW);
        ...
        betterGroundFogState.getFilter().setFogBoundary(currentFogBoundary); // x y and z need to be unitvector pointing
        // away from the fog, w is the distance
        // from the origin, so this is
        // horizontal fog
