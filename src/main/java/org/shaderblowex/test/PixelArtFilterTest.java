...
import org.shaderblowex.filter.PixelArtFilter;
...
public class PixelArtFilterTest extends SimpleApplication implements ActionListener {
    ...
    Integer[] types = new Integer[]{PixelArtFilter.PALETTE_TYPE_LINEAR, PixelArtFilter.PALETTE_TYPE_C64,
        PixelArtFilter.PALETTE_TYPE_CGA, PixelArtFilter.PALETTE_TYPE_CC, PixelArtFilter.PALETTE_TYPE_ANSI,
        PixelArtFilter.PALETTE_TYPE_STRIPE, PixelArtFilter.PALETTE_TYPE_GRAYSCALE,
        PixelArtFilter.PALETTE_TYPE_HEATMAP, PixelArtFilter.PALETTE_TYPE_RAINBOW,
        PixelArtFilter.PALETTE_TYPE_BRIGHTNESS, PixelArtFilter.PALETTE_TYPE_DESERT,
        PixelArtFilter.PALETTE_TYPE_ELECTRICAL, PixelArtFilter.PALETTE_TYPE_NEON, PixelArtFilter.PALETTE_TYPE_FIRE,
        PixelArtFilter.PALETTE_TYPE_TECH, PixelArtFilter.PALETTE_TYPE_HUE,
        PixelArtFilter.PALETTE_TYPE_POSTERIZATION, PixelArtFilter.PALETTE_TYPE_TOONIFICATION,};

    String[] names = new String[]{"Linear", "C64", "CGA", "CC", "ANSI", "Stripe", "Gray", "Heat", "Rainbow", "Bright",
        "Desert", "Electric", "Neon", "Fire", "Tech", "Hue", "Poster", "Toon"
    ...
    public void simpleInitApp() {
        ...
        debugText.setText("EdgWid:" + currentEdgeWidth + " ClrScl:" + currentColorSize + " ClrCnt:" + currentColorCount
                + " PxlRes:" + currentPixelResolution + " PalTyp:" + names[currentpPaletteType]);
