 ...
 * @author xxx
 */
public class BetterToneMapFilterTest_2 extends SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        // 2D reference image
        Geometry geometry = new Geometry("ToneMapFilterGeo",
                new Quad(this.getCamera().getWidth() / 3, this.getCamera().getHeight() / 3));
        ...
        /*
		 * //Shadows DirectionalLightShadowFilter dlsf = new
		 * DirectionalLightShadowFilter(assetManager, 1024, 3); dlsf.setLight(sun);
		 * dlsf.setEnabled(true); FilterPostProcessor fpp = new
		 * FilterPostProcessor(assetManager); fpp.addFilter(dlsf);
		 * viewPort.addProcessor(fpp); // for(Spatial child: sceneAsNode.getChildren())
    ...
    public static void main(String[] args) {
        ...
        BetterToneMapFilterTest_2 app = new BetterToneMapFilterTest_2();
        app.start();
