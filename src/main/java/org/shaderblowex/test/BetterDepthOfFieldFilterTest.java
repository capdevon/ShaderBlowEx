...
import org.shaderblowex.filter.BetterDepthOfFieldFilter;
...
public class BetterDepthOfFieldFilterTest extends SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        debugText.setText("FocDepth:" + currentFocalDepth + " FocLength:" + currentFocalLength + " FStop:"
                + currentFStop + " AutoFocus:" + currentAutoFocus + " ShowFocus:" + currentShowFocus);
