...
import org.shaderblowex.filter.AirFilter;
...
public class AirFilterTest extends SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        debugText.setText("AirDensity:" + currentAirDensity + " AirDistance:" + currentAirDistance + " Desaturation:"
                + currentAirDesaturation);
