...
import org.shaderblowex.filter.BetterGroundFogFilter;
...
public class BetterGroundFogState extends BaseAppState {
    ...
    /**
     * saves a reference to the directional light used as sunlight, to send
     * updated direction to the shader per frame
     *
    ...
    /**
     * sets the duration in seconds it takes to fade from indoors to outdoors /
     * night to day
     *
    ...
    /**
     * used to set indoors state, in indoors state fog color and sunlight color
     * are the same to prevent from light scattering inside
     *
    ...
    /**
     * at night you usually want darker fog and no yellowish light scattering so
     * you can define night colors and then fade to them by activating night
     * mode
     *
    ...
    /**
     * sets the fog color used for fog at daytime that is not influenced by
     * sunlight
     *
     * @param color fogs color, default is (0.5f, 0.6f, 0.7f, 1.0f) slightly
     * blueish gray
     */
    ...
    /**
     * sets the color used for 'lightscattering' at day, that is the color the
     * fog fades into when looking into the direction of the sun
     *
     * @param color sun color, default is (1.0f, 0.9f, 0.7f, 1.0f) slightly
     * yellowish grey
     */
    ...
    /**
     * sets the fog color used for fog at nighttime that is not influenced by
     * sunlight
     *
     * @param color fogs color, default is (0.25f, 0.3f, 0.35f, 1.0f) slightly
     * blueish darker gray
     */
    ...
    /**
     * sets the color used for 'lightscattering' at night, that is the color the
     * fog fades into when looking into the direction of the moon
     *
     * @param color moon color, default is (0.35f, 0.45f, 0.5f, 1.0f) slightly
     * blueish grey
     */
    ...
    /**
     * sets the fog color used for fog indoors that is never influenced by
     * sunlight
     *
     * @param color fogs color, default is (0.10f, 0.10f, 0.14f, 1.0f) slightly
     * blueish darker gray, useful for caves to prevent them from seeming
     * brighter due to grey fog
     */
    ...
    /**
     * sets the color used for 'lightscattering' indoors, that is the color the
     * fog fades into when looking into the direction of the light, default is
     * the same as indoors fog color so you get no lightscattering effect
     * indoors
     *
     * @param color light color, default is (0.10f, 0.10f, 0.14f, 1.0f), same as
     * indoors fog color
     */
    ...
    /**
     * returns a reference to the BetterFogFilter, you need that to get a
     * reference to add to your FilterPostProcessor at the position you prefer
     * (should be after shadows and postprocessing water at least)
     *
