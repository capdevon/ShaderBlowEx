...
import org.shaderblowex.filter.BokehDoFFilter;
...
public class BokehDoFFilterTest extends SimpleApplication implements ActionListener {
    ...
    public void simpleInitApp() {
        ...
        debugText.setText("FocusPoint:" + currentFocusPoint + " RadiusScale:" + currentRadiusScale + " BlurSize:"
                + currentBlurSize + " FocusScale:" + currentFocusScale);
